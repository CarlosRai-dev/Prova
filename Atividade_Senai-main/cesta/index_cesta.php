...
<form action="insert_cesta.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_cestarai" id="ano_cestarai">
  </div>
  <div class="mb-3 container">
    <label for="valor_cestarai" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_cestarai" id="valor_cestarai">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anocestarai']; ?>',  <?= $item['valorcestarai'];?>],
