...
<form action="insert_processador.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_processadorrai" id="ano_processadorrai">
  </div>
  <div class="mb-3 container">
    <label for="valor_processadorrai" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_processadorrai" id="valor_processadorrai">
  </div>
  <div class="container">
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        $query = "SELECT * FROM processadorrai";
        ...
        ?>
            ...
            ['<?=$item['anoprocessadorrai'];?>',<?=$item['valorprocessadorrai'];?>],
