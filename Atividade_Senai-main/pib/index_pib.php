...
<form action="insert_pib.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_pibrai" id="ano_pibrai">
  </div>
  <div class="mb-3 container">
    <label for="valor_pibrai" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_pibrai" id="valor_pibrai">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anopibrai']; ?>',  <?= $item['valorpibrai'];?>],
