...
<form action="insert_dolar.php" method="post">
  <div class="mb-3 container">
    ...
    <input type="text" class="form-control" name="ano_dolarrai" id="ano_dolarrai">
  </div>
  <div class="mb-3 container">
    <label for="valor_dolarrai" class="form-label">Valor</label>
    <input type="text" class="form-control" name="valor_dolarrai" id="valor_dolarrai">
  </div>
  <div class="container">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        ?>
          ...
          ['<?= $item['anodolarrai']; ?>',  <?= $item['valordolarrai'];?>],
